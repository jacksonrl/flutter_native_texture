...
#include "include/flutter_native_texture/flutter_native_texture_plugin.h"
#include "include/flutter_native_texture/sw_pixel_buffer.h"

#define flutter_native_texture_PLUGIN(obj)                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), flutter_native_texture_plugin_get_type(), \
                                FlutterNativeTexturePlugin))

struct _FlutterNativeTexturePlugin {
    GObject parent_instance;
    GHashTable* textures;
    FlTextureRegistrar* registrar;
};

G_DEFINE_TYPE(FlutterNativeTexturePlugin, flutter_native_texture_plugin, g_object_get_type())

typedef FlMethodResponse* (*MethodCallback)(FlutterNativeTexturePlugin* plugin, FlValue* arguments);

static FlMethodResponse* flutter_native_texture_plugin_method_init(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
...
static FlMethodResponse* flutter_native_texture_plugin_method_dispose(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
...
static FlMethodResponse* flutter_native_texture_plugin_method_draw(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
    FlValue* ptr = fl_value_lookup_string(arguments, "texture");
    if (ptr == nullptr) {
        return FL_METHOD_RESPONSE(fl_method_error_response_new("MISSING", "Must specify texture ID", fl_value_new_null()));
    }
...
static FlMethodResponse* flutter_native_texture_plugin_method_invalidate(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
    FlValue* ptr = fl_value_lookup_string(arguments, "texture");
    if (ptr == nullptr) {
        return FL_METHOD_RESPONSE(fl_method_error_response_new("MISSING", "Must specify texture ID", fl_value_new_null()));
    }
...
static FlMethodResponse* flutter_native_texture_plugin_method_read(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
    FlValue* ptr = fl_value_lookup_string(arguments, "texture");
    if (ptr == nullptr) {
        return FL_METHOD_RESPONSE(fl_method_error_response_new("MISSING", "Must specify texture ID", fl_value_new_null()));
    }
...
static FlMethodResponse* flutter_native_texture_plugin_method_get_size(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
    FlValue* ptr = fl_value_lookup_string(arguments, "texture");
    if (ptr == nullptr) {
        return FL_METHOD_RESPONSE(fl_method_error_response_new("MISSING", "Must specify texture ID", fl_value_new_null()));
    }
...
static FlMethodResponse* flutter_native_texture_plugin_method_list(FlutterNativeTexturePlugin* plugin, FlValue* arguments) {
...
static void flutter_native_texture_plugin_handle_method_call(
    FlutterNativeTexturePlugin* self,
...
static void flutter_native_texture_plugin_dispose(GObject* object) {
    g_print("Disposing of SW REND plugin\n");
    FlutterNativeTexturePlugin* plugin = flutter_native_texture_PLUGIN(object);
    GHashTableIter iter;
    g_hash_table_iter_init(&iter, plugin->textures);
    gpointer key, value;
    ...
    G_OBJECT_CLASS(flutter_native_texture_plugin_parent_class)->dispose(object);
}

static void flutter_native_texture_plugin_class_init(FlutterNativeTexturePluginClass* klass) {
    G_OBJECT_CLASS(klass)->dispose = flutter_native_texture_plugin_dispose;
}

static void flutter_native_texture_plugin_init(FlutterNativeTexturePlugin* self) {
    self->textures = g_hash_table_new(g_direct_hash, g_direct_equal);
}

static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
    FlutterNativeTexturePlugin* plugin = flutter_native_texture_PLUGIN(user_data);
    flutter_native_texture_plugin_handle_method_call(plugin, method_call);
}

void flutter_native_texture_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
    // Set up methods
    if (methods == nullptr) {
        methods = g_hash_table_new(g_str_hash, g_str_equal);
        g_hash_table_insert(methods, (gpointer) "init", (gpointer)flutter_native_texture_plugin_method_init);
        g_hash_table_insert(methods, (gpointer) "dispose", (gpointer)flutter_native_texture_plugin_method_dispose);
        g_hash_table_insert(methods, (gpointer) "draw", (gpointer)flutter_native_texture_plugin_method_draw);
        g_hash_table_insert(methods, (gpointer) "invalidate", (gpointer)flutter_native_texture_plugin_method_invalidate);
        g_hash_table_insert(methods, (gpointer) "get_pixels", (gpointer)flutter_native_texture_plugin_method_read);
        g_hash_table_insert(methods, (gpointer) "get_size", (gpointer)flutter_native_texture_plugin_method_get_size);
        g_hash_table_insert(methods, (gpointer) "list_textures", (gpointer)flutter_native_texture_plugin_method_list);
    }

    FlutterNativeTexturePlugin* plugin = flutter_native_texture_PLUGIN(
        g_object_new(flutter_native_texture_plugin_get_type(), nullptr));
    ...
    g_autoptr(FlMethodChannel) channel =
        fl_method_channel_new(fl_plugin_registrar_get_messenger(registrar),
                              "com.funguscow/flutter_native_texture",
                              FL_METHOD_CODEC(codec));
    fl_method_channel_set_method_call_handler(channel, method_call_cb,
                                              g_object_ref(plugin),
                                              g_object_unref);

    g_print("Registering plugin and channel \"com.funguscow/flutter_native_texture\"\n");
